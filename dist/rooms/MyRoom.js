...
const MyRoomState_1 = require("./schema/MyRoomState"); // <-- यह पाथ सही है
class MyRoom extends colyseus_1.Room {
    ...
    onCreate() {
        ...
        this.onMessage("roll_dice", (client) => {
            ...
            const player = this.state.players.get(client.sessionId); // Add type assertion
            if (!player) {
    ...
    onJoin(client, options, auth) {
        ...
        const player = new MyRoomState_1.Player(); // Ensure Player class is defined and imported
    ...
    endGame() {
        ...
        const playersArray = Array.from(this.state.players.values()); // Type assertion for safety
